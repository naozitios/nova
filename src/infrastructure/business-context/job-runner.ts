 ...
 */
export function registerExtractionHandlers(runner: JobRunner): void {
  for (const jobType of EXTRACTION_JOB_TYPES) {
    runner.registerHandler(jobType, createExtractionHandler(jobType))
  }
  runner.registerHandler('quality_gate_check', createQualityGateHandler())
}

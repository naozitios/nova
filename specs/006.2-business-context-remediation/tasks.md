...
- [x] T051 | B43 | Approval SQL: validate readiness, publish sole current v1, audit, approve session atomically.
  <!-- STATUS: VERIFIED — clean Supabase reset plus approve-onboarding atomic/profile-version gate passed 12/12; v3 RPC rechecks readiness from active user-verified facts before atomic version/session/audit writes -->

-- persist_fact_reconciliation: atomic bulk fact write
-- Applies supersession updates then inserts new facts within one transaction.
-- Any invalid insert rolls back all updates and inserts.
...
-- invoker security: restrict execute to service_role only
